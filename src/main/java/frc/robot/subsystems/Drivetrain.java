...
public class Drivetrain extends Subsystem 
{
    ...
    private final DifferentialDrive m_drive = new DifferentialDrive(leftTalonLead, rightTalonLead); 
     
    // The left-side drive encoder
    private final Encoder m_leftEncoder =
    new Encoder()
        
    DriveConstants.kLeftEncoderPorts[0], DriveConstants.kLeftEncoderPorts[1],
    ...
    public void periodic()
    {
        ...
        leftTalonLead.configSelectedFeedbackCoefficient(coefficient)
