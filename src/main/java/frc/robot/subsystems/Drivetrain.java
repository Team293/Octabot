...
/*import frc.robot.Constants.DrivetrainConstants.CLOSED_LOOP_RAMP;
import frc.robot.Constants.DrivetrainConstants.MAX_VELOCITY;
import frc.robot.Constants.DrivetrainConstants.VELOCITY_LIMIT_PERCENTAGE;
import frc.robot.Constants.DrivetrainConstants.VELOCITY_SLOWDOWN_MODIFIER;
import frc.robot.Constants.DrivetrainConstants.INVALID_INPUT;
import frc.robot.Constants.DrivetrainConstants.L_DEADBAND;
import frc.robot.Constants.DrivetrainConstants.R_DEADBAND;*/
...
public class Drivetrain extends Subsystem 
{
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONSr
    ...
    *  where 0 is the deadband and 1 is the max */
    ...
    public void autoDriveVelocity(double leftVelocity, double rightVelocity){
        leftDriveVolts = FEED_FORWARD.calculate(leftVelocity);
        rightDriveVolts = FEED_FORWARD.calculate(rightVelocity);
